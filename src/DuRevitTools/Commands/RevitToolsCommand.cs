...
namespace DuRevitTools
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class RevitToolsCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("4f40bf09-875b-42ca-a382-03315e76c817");
        ...
        /// </summary>
        public static RevitToolsCommand Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(DuRevitToolsPackage package)
        {
            ...
            Instance = new RevitToolsCommand(package, commandService);
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            {
                ToolWindowPane window = await this.package.ShowToolWindowAsync(typeof(RevitTools), 0, true, this.package.DisposalToken);
